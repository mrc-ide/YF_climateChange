...
knitr::opts_chunk$set(
  fig.path = paste0("ClimateChangeBurdenImages-", Sys.Date(), "/"),
  dpi = 300
)
...
Foi_samples = read.csv("Foi_climate_samples_20190207.csv", stringsAsFactors = FALSE)

Foi_median_samples= read.csv("Foi_median_climate_samples_20190207.csv", stringsAsFactors = FALSE)
...
n_samples = nrow(Foi_samples)/3 #10
