...
path = get_latest_file(pattern = "Foi_climate_median_increment_")

Foi_median_increment_samples= read.csv(path, stringsAsFactors = FALSE)
...
path = get_latest_file("Foi_climate_increment_")
Foi_median_increment_samples= read.csv(path, stringsAsFactors = FALSE)
