...
path = "GLM_tempsuit_MCMC_chain_20190206_hamlet"
...
path = "Z:/MultiModelInference/multi_model_MCMC_chain_20180622"

mcmc_out_sero = get_chains(path, burnin = 1, thin = 100)
...
```{r save_incremental_sample, echo=TRUE}
