...
### TEMP SUITABILITY ###
dat_full_temp = cbind(dat_full, temp_suitability(dat_full[,"ERAday.mean"] , apply(mcmc_out[,21:29], 2 ,"median")) )
...
for(i in 1:n_samples){
  ...
  ### TEMP SUITABILITY ###
  dat_full_temp = cbind(dat_full, temp_suitability(dat_full[,"ERAday.mean"] , mcmc_out[sample_ind,21:29])  )
  names(dat_full_temp)[ncol(dat_full_temp)] = "temp_suitability"
  envdat = launch_env_dat(filepath = NA, dat_full = dat_full_temp, c34 = c34)  
