...
#modelVec = "cas.or.out~log.surv.qual.adm0+adm05+lon+logpop+LC14+EVI.mean" 
#########################################################################################################
### LOAD TEMPSUIT DATA ###
#########################################################################################################
### a
...
#path = "Z:/MultiModelInference/chains/GLM_MCMC_chain_20180515"

#get_chains
mcmc_out=get_chains(path, burnin = 1e6, thin = 1)
...
temp_suit = envdat$dat$temp_suitability
...
colours = (snapalette("Ipanema", 100, type = "continuous"))

# plot baseline
YFestimation::plot_transmission_intensity(x, 
                                          ii, 
                                          seroout,
