...
knitr::opts_chunk$set(
  fig.path = "FullProjectionImagesRainfall/",
  dpi = 300
)
```
...
temp_param = apply(mcmc_out[,21:29], 2, median,na.rm = T)

FOI_median_samples = calc_Foi_tempchange(dat_full,
                                         adjusted_params,
                                         temp_param,
                                         scenarios,
                                         c34,
...
```{r save_output, echo=TRUE, eval = FALSE}
...
for(i in 1:n_samples){
  ...
  Foi_tmp = calc_Foi_tempchange(dat_full,
                                adjusted_params,
                                temp_param,
                                scenarios,
                                c34,
