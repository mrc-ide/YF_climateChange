...
glm_mcmc_out = YFestimation::get_chains(path, burnin = 1000, thin = 10)
...
glmpreds_tmp = YFestimation::fun_calcPred( Est_beta, x, type="response")
...
object_glm = YFestimation::fit_glm(dat =envdat$dat, depi = envdat$depi, modelVec )   #fit_glm from Kevin's code, adapted to take models as input
...
### model ###
glmpreds_tmp_add2 = YFestimation::fun_calcPred( Est_beta,x_add2,type="response")
...
### model ###
glmpreds_tmp_add4 = YFestimation::fun_calcPred( Est_beta,x_add4,type="response")
